...
#define mImpAttrAsciiMnuItm		(mFileImpMnu + 5)
...
#define mImpHor2DAsciiMnuItm		(mFileImpMnu + 30)
#define mImpHor3DAsciiMnuItm		(mFileImpMnu + 31)
#define mImpHor3DAsciiAttribMnuItm	(mFileImpMnu + 32)
#define mImpBulkHor2DAsciiMnuItm	(mFileImpMnu + 33)
#define mImpBulkHor3DAsciiMnuItm	(mFileImpMnu + 34)
...
#define mImpWellSimpleMultiMnuItm	(mFileImpMnu + 44)
...
#define mImpFltAsciiMnuItm		(mFileImpMnu + 50)
#define mImpBulkFltAsciiMnuItm		(mFileImpMnu + 51)
#define mImpFltSSAscii2DMnuItm		(mFileImpMnu + 56)
#define mImpFltSSAscii2DBulkMnuItm	(mFileImpMnu + 57)
#define mImpFltSSAscii3DMnuItm		(mFileImpMnu + 58)
#define mImpFltSSAscii3DBulkMnuItm	(mFileImpMnu + 59)
...
#define mImpXPlotAsciiMnuItm		(mFileImpMnu + 111)
...
#define mExpHor3DAsciiMnuItm		(mFileExpMnu + 30)
#define mExpHor2DAsciiMnuItm		(mFileExpMnu + 31)
#define mExpBulkHor3DAsciiMnuItm	(mFileExpMnu + 32)
#define mExpBulkHor2DAsciiMnuItm	(mFileExpMnu + 33)
#define mExpFltAsciiMnuItm		(mFileExpMnu + 50)
#define mExpBulkFltAsciiMnuItm		(mFileExpMnu + 51)
#define mExpFltSSAsciiMnuItm		(mFileExpMnu + 55)
#define mExpBulkFltSSAsciiMnuItm	(mFileExpMnu + 56)
#define mExpPickAsciiMnuItm		(mFileExpMnu + 61)
#define mExpPolyAsciiMnuItm		(mFileExpMnu + 62)
...
#define mExpGeom2DAsciiMnuItm		(mFileExpMnu + 95)
...
#define mManFltMnuItm			(mFileManMnu + 30)
#define mManFltSSMnuItm			(mFileManMnu + 31)
...
#define mManGeom2DMnuItm		(mFileManMnu + 110)
#define mManXPlotMnuItm			(mFileManMnu + 120)
...
#define mExtract2DFrom3DMnuItm		(mProcMnu + 24)
#define mCreate3DFrom2DMnuItm		(mProcMnu + 25)
