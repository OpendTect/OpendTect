...
//Words	 
    ...
    static uiString sEast()		{ return tr("E", "East"); }
    ...
    static uiString sNorth()		{ return tr("N", "North"); }
    ...
    static uiString sSouth()		{ return tr("S", "South"); }
    ...
    static uiString sWest()		{ return tr("W", "West"); }
