...
int mGlobal(PreStackProcessing) dGBPreStackEventsSetSurvey(
	const char* dataroot, const char* survey );
...
int mGlobal(PreStackProcessing) dGBPreStackEventsOpenReader(
...
int mGlobal(PreStackProcessing) dGBPreStackEventsGetRanges(int handle,
...
int mGlobal(PreStackProcessing) dGBPreStackEventsGetNextCDP( int handle,
	int previnl, int prevcrl, int& nextinl, int& nextxrl );
...
int mGlobal(PreStackProcessing) dGBPreStackEventsMoveReaderTo( int handle,
	int inl, int crl );
...
int mGlobal(PreStackProcessing) dGBPreStackEventsGetEventSize( int handle,
	int eventindex );
/*!<
\param handle
...
void mGlobal(PreStackProcessing) dGBPreStackEventsGetEvent( int handle,
	int eventindex, float* offsets, float* angles, float* depths,
	float* weights );
/*!<
\param handle
\param eventindex goes from 0 to getNrEvents() -1
...
void mGlobal(PreStackProcessing) dGBPreStackEventsGetDip( int handle,
	int eventindex, float& inldip, float& crldip );
/*!<
\param handle
\param eventindex goes from 0 to getNrEvents() -1
\param inldip dip when going in the direction of increasing inline numbers
\param crldip dip when going in the direction of increasing crossline numbers
*/

void mGlobal(PreStackProcessing) dGBPreStackEventsGetEventWeight( int handle,
	int eventindex, float& weight );

int mGlobal(PreStackProcessing) dGBPreStackEventsGetHorizonID( int handle,
	int eventindex, int& horid );
