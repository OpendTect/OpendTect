		             ...
		             const Coord3& r2, const Coord3& r3 )
{
    ...
    const double d3[9] = { r1.x_, r1.y_, r1.z_, r2.x_, r2.y_, r2.z_, r3.x_, r3.y_,r3.z_};
	...
	const Coord3& b, const Coord3& c, const Coord3& d )
{
    ...
    const Coord3 ac = a-c;
    const Coord3 ad = a-d;
    const double t[9] = { ab.x_, ab.y_, ab.z_, ac.x_, ac.y_, ac.z_, ad.x_, ad.y_, ad.z_};
...
{
    if ( (p.x_>a.x_ && p.x_>b.x_ && p.x_>c.x_) || (p.x_<a.x_ && p.x_<b.x_ && p.x_<c.x_) ||
         (p.y_>a.y_ && p.y_>b.y_ && p.y_>c.y_) || (p.y_<a.y_ && p.y_<b.y_ && p.y_<c.y_) )
	return false;
...
public:
			...
			Sphere(const Coord3& crd)
                            : radius((float) crd.x_),theta((float) crd.y_)
                            , phi((float) crd.z_)		{}
