...
system (or any other transformed cartesian) and UI coord system (screen
coord system.)

  Use the constructor or call set() to set up the two coord systems.
  1) If the origin of UI is not at (0,0), use uiRect instead of uiSize to set
     up the UI coordinates.
  2) In many cases the 'border' of world coord system is not at a good
