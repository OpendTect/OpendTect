...
HiddenParam<uiToolBarCommandEditor, CommandDefs*> hp_commands_( nullptr );

CommandDefs& uiToolBarCommandEditor::commands_()
{
    return *hp_commands_.getParam( this );
}

CommandDefs& uiToolBarCommandEditor::commands_() const
{
    return *hp_commands_.getParam( this );
}
...
uiToolBarCommandEditor::uiToolBarCommandEditor( uiParent* p,
    ...
    , changed(this)
{
    hp_commands_.setParam( this, new CommandDefs(commands) );
...
uiToolBarCommandEditor::uiToolBarCommandEditor( uiParent* p,
    ...
    , changed(this)
{
    hp_commands_.setParam( this, new CommandDefs );
...
{
    detachAllNotifiers();
    hp_commands_.removeAndDeleteParam( this );
}
