...
static HiddenParam<uiFuncDispBase::Setup,OD::Orientation>
    hp_orientation(OD::Horizontal);

uiFuncDispBase::Setup::Setup()
    ...
    , showlegend_(false)
{
    hp_orientation.setParam(this, OD::Horizontal);
}


uiFuncDispBase::Setup::Setup(const Setup& su)
{
    *this = su;
    hp_orientation.setParam(this, su.getOrientation());
}
...
void uiFuncDispBase::Setup::setOrientation( OD::Orientation orient )
{
    hp_orientation.setParam(this, orient);
}


OD::Orientation uiFuncDispBase::Setup::getOrientation() const
{
    return hp_orientation.getParam(this);
}
