    ...
    , nrhdrlns_(nrlns)
{
    ...
    uiString  lbltxt = tinf_.isOptional()
	    ? toUiString("[%1]").arg(dispnm) : dispnm;
    ...
    {
	crsfld_ = new Coords::uiCoordSystemSel(this, uiStrings::sCoordSys(),
...
void addInp( int iform, int ifld )
{
    ...
    uiGenInput* inp = new uiGenInput( this, uiString::empty(),
...
uiString getSummary() const
{
	...
	ret = tr("Incomplete").embedFinalState();
    else
    {
