...
void removeButCB( CallBacker* )
{
     ...
     removeEntries( selectedrows, false );
}
...
void removeEntries( const TypeSet<int>& rows, bool forreset )
{
...
void getEntries( ObjectSet<Mnemonic>& mns ) const
{
...
bool commitEntries( ObjectSet<Mnemonic>& mns )
{
