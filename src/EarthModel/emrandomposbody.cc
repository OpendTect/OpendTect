...
static const char* rcsID = "$Id: emrandomposbody.cc,v 1.8 2009-07-22 10:50:45 cvsranojay Exp $";
...
void RandomPosBody::copyFrom( const DataPointSet& data, bool onlyselected )
{
    locations_.erase();
    ids_.erase();
    ...
    {
	if ( !onlyselected || data.isSelected(idx) )
	{
