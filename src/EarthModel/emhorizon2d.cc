...
int Horizon2DAscIO::getNextLine( BufferString& lnm, Coord& crd, int& nr,
				 TypeSet<float>& data )
{
    float dummyspnr = mUdf(float);
    return Horizon2DAscIO::getNextLineWithSP( lnm, crd, nr, dummyspnr, data );
}


int Horizon2DAscIO::getNextLineWithSP( BufferString& lnm, Coord& crd, int& nr,
