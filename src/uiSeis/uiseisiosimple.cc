...
void uiSeisIOSimple::mkIsAscFld()
{
    isascfld_ = new uiGenInput( this, tr("File type"),
		BoolInpSpec(true,uiStrings::sASCII(),uiStrings::sBinary()) );
...
bool uiSeisIOSimple::acceptOK()
{
    ...
    const uiString msg = tr("Success.\n\nDo you want to %1 more?")
		    .arg(isimp_ ? uiStrings::sImport() : uiStrings::sExport());
