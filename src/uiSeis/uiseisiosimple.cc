...
uiSeisIOSimple::uiSeisIOSimple( uiParent* p, Seis::GeomType gt, bool imp )
    ...
    , sdfld_(nullptr)
    , havenrfld_(nullptr)
    , haverefnrfld_(nullptr)
    , isxyfld_(nullptr)
    , inldeffld_(nullptr)
    , nrdeffld_(nullptr)
    , startposfld_(nullptr)
    , startnrfld_(nullptr)
    , stepposfld_(nullptr)
    , stepnrfld_(nullptr)
    , offsdeffld_(nullptr)
    , pspposlbl_(nullptr)
    , haveoffsbut_(nullptr)
    , haveazimbut_(nullptr)
    , subselfld_(nullptr)
    , lnmfld_(nullptr)
    ...
    , isimp_(imp)
{
	...
	fnmfld_->valuechanged.notify( mCB(this,uiSeisIOSimple,inpFileSel) );
	...
	isxyfld_->valuechanged.notify(
			mCB(this,uiSeisIOSimple,positionInFileSelChg) );
