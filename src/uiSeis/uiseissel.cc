...
static HiddenParam<uiSeisSel::Setup,char> hp_withunitsel_(false);
...
{
    hp_withunitsel_.removeParam( this );
}
...
bool uiSeisSel::Setup::withUnitSel() const
{
    return hp_withunitsel_.getParam( this );
}
...
bool uiSeisSel::enableTimeDepthToogle() const
{
    const bool withunitsel =
		seissetup_.enabotherdomain_ && seissetup_.withUnitSel();
