...
HiddenParam<uiSeisPartServer,uiSeisExpCubePositionsDlg*> expcubeposdlgmgr_(0);
...
uiSeisPartServer::uiSeisPartServer( uiApplService& a )
    ...
    , expps2dseisdlg_(0)
{
    expcubeposdlgmgr_.setParam( this, 0 );
...
uiSeisPartServer::~uiSeisPartServer()
{
    ...
    expcubeposdlgmgr_.removeAndDeleteParam( this );
}
...
void uiSeisPartServer::survChangedCB( CallBacker* )
{
    ...
    delete expcubeposdlgmgr_.getParam( this );
    expcubeposdlgmgr_.setParam( this, 0 );
}
...
{
    uiSeisExpCubePositionsDlg* expcubeposdlg = expcubeposdlgmgr_.getParam(this);
    if ( !expcubeposdlg )
    {
	expcubeposdlg = new uiSeisExpCubePositionsDlg( parent() );
	expcubeposdlgmgr_.setParam( this, expcubeposdlg );
    }

    if ( key )
	expcubeposdlg->setInput( *key );
