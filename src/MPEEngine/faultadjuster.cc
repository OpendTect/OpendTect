...
static const char* rcsID = "$Id: faultadjuster.cc,v 1.1 2005-12-12 17:26:39 cvskris Exp $";
...
#define mGetNormal( tg ) \
    const float abs = sqrt(tg.inl*tg.inl + tg.crl*tg.crl); \
