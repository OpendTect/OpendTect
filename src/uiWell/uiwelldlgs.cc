    ...
    , origgl_(d.info().groundelev)
{
    ...
    mAttachCB( postFinalise(), uiWellTrackDlg::initDlg );
}
    ...
    , replvelfld_(nullptr)
{
    ...
    mAttachCB( postFinalise(), uiD2TModelDlg::initDlg );
}
    ...
    : uiDialog(p,Setup(tr("Set Depth-Time Model"),mNoDlgTitle,mTODOHelpKey))
{
    ...
    wellfld_->attach( alignedBelow, velfld );
