...
________________________________________________________________________
 ...
 Author:	Umesh Sinha
 Date:		June 2008
 RCS:		$Id: uiprestackimpmute.cc,v 1.1 2008-06-23 06:51:42 cvsumesh Exp $
________________________________________________________________________
    ...
    ,fd_(*PreStack::MuteAscIO::getDesc())
{
    ...
    extptypefld_ = new uiGenInput(this,"Extrapolate Type",
	                          StringListInpSpec(extrapoltypes));
    extptypefld_->attach(alignedBelow, inpfld_ );

    uiSeparator* sep = new uiSeparator( this, "H sep");
    sep->attach(stretchedBelow, extptypefld_);

    dataselfld_ = new uiTableImpDataSel( this, fd_, 0);
    dataselfld_->attach( alignedBelow, extptypefld_ );
...
bool uiImportMute::acceptOK(CallBacker*)
{
    ...
    if( muteascio.getMuteDef( mutedef, true, getInterpolType() ) )
...
{
    PointBasedMathFunction::InterpolType iptype =PointBasedMathFunction::Linear;
    
    const int typeval = extptypefld_->getIntValue();
     if(typeval == 1)
