...
static const char* rcsID = "$Id: uiprestackanglemute.cc,v 1.1 2011-01-26 23:10:42 cvsyuancheng Exp $";
    ...
    , processor_( rt )		      
{
   ...
   if ( !rt->velocityVolumeID().isEmpty() )
    ...
    cutofffld_ = new uiGenInput(this, "Mute Cutoff", FloatInpSpec(false));
