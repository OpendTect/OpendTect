...
od_istream::od_istream( const OS::MachineCommand& mc, const char* workdir )
...
od_ostream::od_ostream( const char* fnm, bool useexist )
...
od_ostream::od_ostream( const FilePath& fp, bool useexist )
    : od_stream(fp,true,useexist)
{}


od_ostream::od_ostream( const OS::MachineCommand& mc, const char* workdir )
