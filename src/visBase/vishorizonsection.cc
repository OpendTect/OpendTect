...
bool HorizonSection::getTitleCoordinates( int titleidx, 
...
const unsigned char* HorizonSection::getTextureData( int titleidx, int& width, 
    int& height ) const
{
...
bool HorizonSection::getTitleTextureCoordinates( int titleidx, 
