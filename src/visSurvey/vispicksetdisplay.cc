...
static const char* rcsID = "$Id: vispicksetdisplay.cc,v 1.88 2006-08-17 13:43:32 cvsjaap Exp $";
...
visBase::VisualObject* PickSetDisplay::createLocation( 
					    const Pick::Location& loc) const
{
