...
-*/
static const char* mUnusedVar rcsID = "$Id: vishorizondisplay.cc,v 1.161 2012-05-02 11:54:12 cvskris Exp $";
				       ...
				       BufferString& info ) const
{
	...
	if ( !mIsUdf(fval) )
	{
		...
		attribshift =
		    attribshifts[version] * survinfo_->zDomain().userFactor();

	    const float zshift =
		getTranslation().z*survinfo_->zDomain().userFactor();
