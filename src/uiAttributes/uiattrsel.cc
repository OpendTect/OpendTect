...
-*/
static const char* rcsID = "$Id: uiattrsel.cc,v 1.44 2009-07-22 16:01:37 cvsbert Exp $";
...
{
    ignoreid = ad ? ad->id() : DescID::undef();
}
...
{
    uiAttrSelDlg dlg( this, lbl_->text(), attrdata_, ignoreid );
    if ( dlg.go() )
    {
