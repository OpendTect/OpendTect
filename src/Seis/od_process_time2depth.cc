...
bool BatchProgram::doWork( od_ostream& strm )
{
	...
	for ( int idx=0; idx<geomids.size(); idx++ )
	{
	    ...
	    auto* exec =
		new SeisZAxisStretcherNew( *inputioobj, *outputioobj, outputcs,
    ...
    VelocityModelScannerNew scanner( *outputioobj, *veldesc );
    ...
    VelocityStretcherNew::setRange( scanner.getTopVAvg(), *veldesc, true,
				 outputioobj->pars() );
    VelocityStretcherNew::setRange( scanner.getBotVAvg(), *veldesc, false,
				 outputioobj->pars() );
