...
static HiddenParam<SeisCubeCopier,Vel::Worker*> seiscopyworkermgr_(nullptr);
...
const Vel::Worker* SeisCubeCopier::worker_() const
{
    return seiscopyworkermgr_.getParam( this );
}


Vel::Worker* SeisCubeCopier::worker_()
{
    return seiscopyworkermgr_.getParam( this );
}
...
bool SeisCubeCopier::init()
{
    ...
    {
	seiscopyworkermgr_.deleteAndNullPtrParam( this );
	auto* worker = new Vel::Worker( veldesc, SI().seismicReferenceDatum(),
