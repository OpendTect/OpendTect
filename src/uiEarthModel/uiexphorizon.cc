	      ...
	      float val, const Coord& crd, int segid )
{
    ...
    sprintf_s( buf, mDataGFLineLen + 2, "%16.8E%16.8E%3d%3d%9.2f%10.2f%10.2f%5d%14.7E I%7d %52s\n",
		    ...
		    const char* comment )
{
    ...
    hnm.clean();
    sprintf_s( gfbuf, mHdr1GFLineLen + 2, "PROFILE %17sTYPE 1  4 %45s3d_ci7m.ifdf     %s ms\n",
		    "", "", SI().xyInFeet() ? "ft" : "m " );
