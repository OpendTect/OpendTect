...
int _post( const char* path, const IOPar& postvars, BufferString& errmsg )
{
    ...
    {
	QString keystr = postvars.getKey( idx );
	QString valstr = postvars.getValue( idx );
...
protected:
    ...
    static const char*	sKeyPost()	    { return "POST"; };
    static const char*	sKeyHost()	    { return "Host"; };
    static const char*	sKeyContentType()   { return "Content-Type"; };
    static const char*	sKeyContentLength() { return "Content-Length"; };
};
