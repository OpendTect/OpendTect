...
-*/
static const char* mUnusedVar rcsID = "$Id: uiwellattribxplot.cc,v 1.49 2012-05-02 11:54:06 cvskris Exp $";
    	...
    	, dpsdispmgr_(0)
{
    ...
    postFinalise().notify( mCB(this, uiWellAttribCrossPlot, initWin ) );
}
