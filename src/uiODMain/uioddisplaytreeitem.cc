...
uiODDisplayTreeItem::uiODDisplayTreeItem()
    ...
    , addmnuitem_(uiStrings::sAdd(true),cAddIdx)
    , addattribmnuitem_(uiStrings::sAttribute(),cAttribIdx)
    , addvolprocmnuitem_(tr("&Volume Processing Attribute"),cAttribIdx)
    , displaymnuitem_(uiStrings::sDisplay(),cDisplayIdx)
    , duplicatemnuitem_(uiStrings::sDuplicate(),cDuplicateIdx)
    , histogrammnuitem_(tr("Histogram..."),cHistogramIdx)
