					       ...
					       visBase::ThumbWheel* tw )
{
	...
	if ( handler )
	{
	    auto* osgtw = sCast(osgGeo::ThumbWheel*,tw->osgNode(true));
...
void ui3DViewerBody::setSceneID( int sceneid )
{
    ...
    const unsigned int numchild = offscreenrenderswitch_->getNumChildren();
    offscreenrenderswitch_->removeChildren( 0, numchild );
