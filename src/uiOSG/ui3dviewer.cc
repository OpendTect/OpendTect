...
HiddenParam<ui3DViewerBody,Timer*> hp_timers(nullptr);
    ...
    , mapview_(false)
{
    ...
    auto* viewalltimer = new Timer;
    hp_timers.setParam( this, viewalltimer );
    mAttachCB( viewalltimer->tick, ui3DViewerBody::viewAllCB );
}
...
ui3DViewerBody::~ui3DViewerBody()
{
    detachAllNotifiers();
    delete &keybindman_;
    hp_timers.removeAndDeleteParam( this );
