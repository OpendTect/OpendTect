				   ...
				   int odversion ) const
{
	...
	handleOldMathExpressionv50( descpar, defstring, odversion );
}


//not used anymore, kept because of ABI freeze
...
void DescSet::handleOldMathExpressionv50( IOPar& descpar,
					BufferString& defstring,
					int odversion ) const
{
