...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_coherencyAtti_on_horDemo1.jpg"
Ok
...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_convolveAtti_on_horDemo1.jpg"
Ok
...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_curvatureAtti_on_horDemo1.jpg"
Ok
...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_DipangleAtti_on_horDemo1.jpg"
Ok
...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_EnergyAtti_on_horDemo1.jpg"
Ok
...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_EventAtti_on_horDemo1.jpg"
Ok
...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_FrequencyAtti_on_horDemo1.jpg"
Ok
...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_FreqFilterAtti_on_horDemo1.jpg"
Ok
...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_GapdeconAttr_on_horDemo1.jpg"
Ok
...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_InstantaAtti_on_horDemo1.jpg"
Ok
...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_PositionAtti_on_horDemo1.jpg"
Ok
...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_ReferShiftAtti_on_horDemo1.jpg"
Ok
...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_ScalingAtti_on_horDemo1.jpg"
Ok
...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_SimilarityAtti_on_horDemo1.jpg"
Ok
...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_SpectralDecAtti_on_horDemo1.jpg"
Ok
...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_VelFanfilAtti_on_horDemo1.jpg"
Ok
...
Button "Scene"
Ok
Input "Select filename" "$SNAPSHOTSDIR$/$IDX$_VolStatiAtti_on_horDemo1.jpg"
Ok
