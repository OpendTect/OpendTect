...
macro ( OD_WRITE_ALOFILES BASEDIR )
	...
	foreach( EXEC ${OD_ALO_FILE_EXECS_${OD_ALO_NAME}} )
		...
		list( FIND OD_EXT_MODULE_DEPS ${ENTRY} INDEX )
		if( ${INDEX} EQUAL -1 )
		    list( FIND OD_CORE_MODULE_NAMES_${OD_SUBSYSTEM} ${ENTRY} _index )
		    if ( NOT ${_index} EQUAL -1 )
			continue()
		    endif()
		    set(WRITENAME ${ENTRY})
		else()
		    set(WRITENAME EXT_LIB_${ENTRY})
		endif()
		if ( FIRST )
		    file( WRITE ${OD_ALOFILE} ${WRITENAME} ${OD_LINESEP} )
		    set ( FIRST )
		else()
		    file( APPEND ${OD_ALOFILE} ${WRITENAME} ${OD_LINESEP} )
		endif()
	    endforeach()
	    install( FILES ${OD_ALOFILE} DESTINATION ${MISC_INSTALL_PREFIX}/plugins/${OD_PLFSUBDIR} )
	endforeach()
    endforeach()
endmacro()
