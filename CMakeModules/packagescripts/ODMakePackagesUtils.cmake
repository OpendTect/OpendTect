...
macro ( OD_GENERATE_BREAKPAD_SYMBOLS ALLLIBS EXECS)
    ...
    set( SYMBOLDIR symbols_${OD_PLFSUBDIR}_${FULLVER_NAME} )
    if( NOT EXISTS ${CMAKE_INSTALL_PREFIX}/${SYMBOLDIR} )
	    file( MAKE_DIRECTORY ${CMAKE_INSTALL_PREFIX}/${SYMBOLDIR} )
    endif()
...
elseif( WIN32 )
	...
	if ( UNIX )
	    execute_process( COMMAND "${SYMGENCMD}" ${CMAKE_INSTALL_PREFIX}/bin/${OD_PLFSUBDIR}/Release/${FILENAME} OUTPUT_FILE ${CMAKE_INSTALL_PREFIX}/${SYMBOLDIR}/${FILENAME}.sym )
	elseif( WIN32 )
	    execute_process( COMMAND "${SYMGENCMD}" ${BINARY_DIR}/bin/${OD_PLFSUBDIR}/Release/${FILENAME}.pdb OUTPUT_FILE ${CMAKE_INSTALL_PREFIX}/${SYMBOLDIR}/${FILENAME}.sym )
	endif()

	file( STRINGS ${CMAKE_INSTALL_PREFIX}/${SYMBOLDIR}/${FILENAME}.sym STUFF LIMIT_COUNT 1 )
	string( REGEX REPLACE " " ";" NEWSTUFF ${STUFF} )
	set( WORDS ${NEWSTUFF} )
	list( GET WORDS 3 SYMADDRESS ) #assuming 4th word is symbol address
	if( UNIX )
	    file( MAKE_DIRECTORY ${CMAKE_INSTALL_PREFIX}/${SYMBOLDIR}/${FILENAME}/${SYMADDRESS} )
	elseif( WIN32 )
	    file( MAKE_DIRECTORY ${CMAKE_INSTALL_PREFIX}/${SYMBOLDIR}/${FILENAME}.pdb/${SYMADDRESS} )
	endif()

	if ( UNIX )
	    file( RENAME ${CMAKE_INSTALL_PREFIX}/${SYMBOLDIR}/${FILENAME}.sym ${CMAKE_INSTALL_PREFIX}/${SYMBOLDIR}/${FILENAME}/${SYMADDRESS}/${FILENAME}.sym )
	elseif( WIN32 )
	    file( RENAME ${CMAKE_INSTALL_PREFIX}/${SYMBOLDIR}/${FILENAME}.sym ${CMAKE_INSTALL_PREFIX}/${SYMBOLDIR}/${FILENAME}.pdb/${SYMADDRESS}/${FILENAME}.sym )
	endif()
	if( UNIX )
