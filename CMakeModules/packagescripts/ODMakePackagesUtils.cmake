...
elseif( WIN32 )
	...
	elseif( WIN32 )
	    execute_process( COMMAND "${SYMGENCMD}" ${BINARY_DIR}/bin/${OD_PLFSUBDIR}/Release/${FILENAME}.pdb OUTPUT_FILE ${CMAKE_INSTALL_PREFIX}/symbols/${FILENAME}.sym )
	endif()
	...
	elseif( WIN32 )
	    file( MAKE_DIRECTORY ${CMAKE_INSTALL_PREFIX}/symbols/${FILENAME}.pdb/${SYMADDRESS} )
	endif()

	if ( UNIX )
	    file( RENAME ${CMAKE_INSTALL_PREFIX}/symbols/${FILENAME}.sym ${CMAKE_INSTALL_PREFIX}/symbols/${FILENAME}/${SYMADDRESS}/${FILENAME}.sym )
	elseif( WIN32 )
	    file( RENAME ${CMAKE_INSTALL_PREFIX}/symbols/${FILENAME}.sym ${CMAKE_INSTALL_PREFIX}/symbols/${FILENAME}.pdb/${SYMADDRESS}/${FILENAME}.sym )
	endif()
	if( UNIX )
