...
macro( ADD_LD_LIBRARY_PATH )
	...
	if ( (NOT "${CXXPATH}" STREQUAL "/usr/lib") AND 
	    ...
	    list ( APPEND LDPATH ${CXXPATH} )
	endif()
    endif()
    if ( NOT "${OD_MODULE_RUNTIMEPATH}" STREQUAL "" )
	list( APPEND LDPATH ${OD_MODULE_RUNTIMEPATH} )
    endif()
    if ( NOT "${LDPATH}" STREQUAL "" )
	list ( JOIN LDPATH ":" LDPATHSTR )
	list ( APPEND TEST_ARGS --ldpathdir ${LDPATHSTR} )
    endif()
endmacro( ADD_LD_LIBRARY_PATH )
