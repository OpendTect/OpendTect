...
function( OD_ADD_KEYWORD_TEST KW NM MSG )
    if ( UNIX AND NOT APPLE )
	set( CMD "${OpendTect_DIR}/testscripts/FindKeyword.sh" )
...
function( OD_ADD_REGEXP_TEST KW NM MSG )
    if ( UNIX )
	set( CMD "${OpendTect_DIR}/testscripts/FindKeyword.sh" )
	list( APPEND CMD "--keyword" "${KW}" "--listfile" "${OD_SOURCELIST_FILE}" )
...
function( OD_ADD_PNG_COMPRESSION_TEST )
    if ( UNIX AND ARGN )
	find_program( PNGQUANT_PROGRAM "pngquant" )
	if ( PNGQUANT_PROGRAM )
	    add_test( "PNGCompression"
		      "${OpendTect_DIR}/testscripts/FindCompactablePNGs.sh"
		      ${ARGN} )
	endif()
    endif()
endfunction()
