...
macro( OD_FIND_OSG )
	...
	cmake_policy(POP)
	if ( NOT OSG_FOUND )
	    message( SEND_ERROR "Cannot find/use the OpenSceneGraph installation" )
	elseif ( NOT OPENTHREADS_FOUND )
	    message( SEND_ERROR "Cannot find/use the OpenThreads library" )
	elseif( NOT OSGGEO_FOUND )
	    message( SEND_ERROR "Cannot find/use the OpenSceneGraph-osgGeo library" )
	endif()
...
macro(OD_SETUP_OSG)
	...
	if ( TARGET osg::osg AND TARGET osg::osgGeo )
