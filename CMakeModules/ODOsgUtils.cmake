...
macro( OD_ADD_OSGGEO )
	...
	set( OSGGEO_INCLUDE_DIR "${OSGGEO_EXT_DIR}/inst/Contents/Resources/include" CACHE FILEPATH "Path to a file." )
	...
	set( OSGGEO_INCLUDE_DIR "${OSGGEO_DIR}/include" CACHE FILEPATH "Path to a file." )
...
macro( OD_ADD_OSG )
	...
	cmake_policy(PUSH)
	cmake_policy(SET CMP0017 NEW)
	find_package( OpenSceneGraph QUIET COMPONENTS ${OSG_FIND_MODULES} CONFIG GLOBAL PATHS "${OSG_ROOT}" HINTS "${CMAKE_PREFIX_PATH}" NO_DEFAULT_PATH )
	if ( NOT OSG_FOUND )
