...
function( OD_CREATE_VSCODE_LAUNCHER )
	...
	if ( APPLE )
	    set( VSCODE_DEBUG_PATHENVVAL "${VSCODE_DEBUG_PATHENVVAL}${_pathsep}${OD_BINARY_BASEDIR}/Contents/MacOS/Debug${_pathsep}\${env:${_pathstr}}" )
	    set( VSCODE_RELEASE_PATHENVVAL "${VSCODE_RELEASE_PATHENVVAL}${_pathsep}${OD_BINARY_BASEDIR}/Contents/MacOS${_pathsep}\${env:${_pathstr}}" )
	else()
	    set( VSCODE_DEBUG_PATHENVVAL "${VSCODE_DEBUG_PATHENVVAL}${_pathsep}${OD_BINARY_BASEDIR}/bin/${OD_PLFSUBDIR}/Debug${_pathsep}\${env:${_pathstr}}" )
	    set( VSCODE_RELEASE_PATHENVVAL "${VSCODE_RELEASE_PATHENVVAL}${_pathsep}${OD_BINARY_BASEDIR}/bin/${OD_PLFSUBDIR}/Release${_pathsep}\${env:${_pathstr}}" )
	endif()
    endif()
