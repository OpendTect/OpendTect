...
function( OD_CREATE_VSCODE_LAUNCHER )
	...
	get_template_filepath( "../launcher-templates/vscode_launch_msvc" VSCODE_LAUNCH_TEMPLATE )
    else()
	get_template_filepath( "../launcher-templates/vscode_launch" VSCODE_LAUNCH_TEMPLATE )
    endif()
    get_template_filepath( "../launcher-templates/c_cpp_properties.json" VSCODE_CPP_PROPERTIES_TEMPLATE )
    if ( NOT VSCODE_DEBUGGER_TYPE )
	if ( CMAKE_CXX_COMPILER_ID STREQUAL "MSVC" )
	...
	if ( ${VSCODE_DEBUGGER} STREQUAL "gdb" )
	    set( VSCODE_MIMODE ${VSCODE_DEBUGGER} )
	...
	elseif ( ${VSCODE_DEBUGGER} STREQUAL "lldb" )
	    set( VSCODE_MIMODE ${VSCODE_DEBUGGER} )
