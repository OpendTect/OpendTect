...
if ( WIN32 )
    set ( OD_EXEC_INSTALL_PATH_RELEASE "${OD_EXEC_OUTPUT_RELPATH}" )
    set ( OD_EXEC_INSTALL_PATH_DEBUG "${OD_EXEC_OUTPUT_RELPATH}" )
...
macro ( OD_INSTALL_LIBRARY SOURCE CONFIGURATION )
	...
	install( PROGRAMS ${PATH} DESTINATION ${OD_EXEC_INSTALL_PATH_DEBUG} RENAME ${FILENAME} CONFIGURATIONS Debug )
	...
	install( PROGRAMS ${PATH} DESTINATION ${OD_EXEC_INSTALL_PATH_RELEASE} RENAME ${FILENAME} CONFIGURATIONS Release )
    endif()
endmacro()
