...
function( get_thirdparty_targets _var )
    ...
    set( _deps )
    foreach( _dep ${_rawdeps} )
	get_target_property( TARGET_TYPE ${_dep} TYPE )
	if ( TARGET_TYPE AND ("${TARGET_TYPE}" STREQUAL "SHARED_LIBRARY" OR
			      "${TARGET_TYPE}" STREQUAL "UNKNOWN_LIBRARY") )
...
function( get_thirdparty_libs _deps _var )
	...
	if ( UNIX )
		...
		if ( TARGET_TYPE AND "${TARGET_TYPE}" STREQUAL "SHARED_LIBRARY" )
		    list( APPEND _libs "$<TARGET_SONAME_FILE_NAME:${_dep}>" )
		else()
