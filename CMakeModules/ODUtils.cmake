...
macro (OD_COPY_PYTHON_EXTERNALS)
	set( PYTHON_LIBS_DESTINATION "${CMAKE_BINARY_DIR}/${MISC_INSTALL_PREFIX}/bin/python" )
	file(MAKE_DIRECTORY "${PYTHON_LIBS_DESTINATION}")
	if ( IS_DIRECTORY "${CMAKE_SOURCE_DIR}/external/odpy" )
	    file(COPY "${CMAKE_SOURCE_DIR}/external/odpy" DESTINATION "${PYTHON_LIBS_DESTINATION}")
	endif()
