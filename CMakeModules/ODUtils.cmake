...
function( OD_CREATE_VSCODE_LAUNCHER )
    ...
    string( JSON VSCODE_PATHENV SET "${VSCODE_PATHENV}" "name" "\"PATH\"" )
    if ( "${CMAKE_BINARY_DIR}" STREQUAL "${OD_BINARY_BASEDIR}" )
        set( VSCODE_DEBUG_PATHENVVAL "${VSCODE_DEBUG_PATHENVVAL}${_pathsep}\$ENV{PATH}" )
	set( VSCODE_RELEASE_PATHENVVAL "${VSCODE_RELEASE_PATHENVVAL}${_pathsep}\$ENV{PATH}" )
	...
	if ( APPLE )
	    set( VSCODE_DEBUG_PATHENVVAL "${VSCODE_DEBUG_PATHENVVAL}${_pathsep}${OD_BINARY_BASEDIR}/Contents/MacOS/Debug${_pathsep}\$ENV{PATH}" )
	    set( VSCODE_RELEASE_PATHENVVAL "${VSCODE_RELEASE_PATHENVVAL}${_pathsep}${OD_BINARY_BASEDIR}/Contents/MacOS${_pathsep}\$ENV{PATH}" )
	else()
            set( VSCODE_DEBUG_PATHENVVAL "${VSCODE_DEBUG_PATHENVVAL}${_pathsep}${OD_BINARY_BASEDIR}/bin/${OD_PLFSUBDIR}/Debug${_pathsep}\$ENV{PATH}" )
	    set( VSCODE_RELEASE_PATHENVVAL "${VSCODE_RELEASE_PATHENVVAL}${_pathsep}${OD_BINARY_BASEDIR}/bin/${OD_PLFSUBDIR}/Release${_pathsep}\$ENV{PATH}" )
	endif()
	string( JSON VSCODE_PATHENV SET "${VSCODE_PATHENV}" "value" "\"${VSCODE_DEBUG_PATHENVVAL}\"" )
	string( JSON VSCODE_DEBUGENV SET "${VSCODE_DEBUGENV}" 0 "${VSCODE_PATHENV}" )
	string( JSON VSCODE_PATHENV SET "${VSCODE_PATHENV}" "value" "\"${VSCODE_RELEASE_PATHENVVAL}\"" )
