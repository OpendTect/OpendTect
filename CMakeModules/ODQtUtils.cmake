...
macro(OD_SETUP_QT)
	...
	if ( OD_SUBSYSTEM MATCHES ${OD_CORE_SUBSYSTEM} )
		...
		if( UNIX OR APPLE )
		    ...
		    #installing linx Qtlibs(like libQtGui.so.4,libQtCore.so.4 etc. )
			file( GLOB ALLLIBS ${QTDIR}/lib/${QLIBNAME}.so.[0-9] )
		    elseif( APPLE )
		    #installing Mac Qtlibs(like libQtGui.4.dylib,libQtCore.4.dylib etc. )
			file( GLOB ALLLIBS ${QTDIR}/lib/${QLIBNAME}.[0-9].dylib )
		    endif()
	    ...
	    endforeach()
	    if( WIN32 )
		#installing Win Qt dlls(QtCore4.dll, QtGui4.dll etc. )
