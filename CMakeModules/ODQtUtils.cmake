...
macro( QT_SETUP_GUI_EXTERNALS )
	...
	if ( NOT EXISTS "${QT_INSTALL_BINS}/${D3D_FILE}" )
	    message(STATUS "Copying system ${D3D_FILE} into environment.")
	    file( COPY "$ENV{WINDIR}/System32/${D3D_FILE}" DESTINATION "${QT_INSTALL_BINS}" )
	endif()
	set( QT_GUI_ADDS "${QT_INSTALL_BINS}/${D3D_FILE}" "${QT_INSTALL_BINS}/${OPENGL_FILE}" )
