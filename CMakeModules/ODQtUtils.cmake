...
macro( QT_SETUP_PRINTSUPPORT_INTERNALS )
	...
	if ( TARGET Cups::Cups )
		...
		"${CTEST_CUSTOM_WARNING_EXCEPTION} \"warning: dylib.*libcups\.dylib.*was built for newer macOS version.*than being linked\"" )
...
macro( OD_ADD_QTMODS )
	...
	if ( QT_VERSION )
		...
		if ( TARGET Qt${QT_VERSION_MAJOR}::${QTMOD} )
		    ...
		    find_package( Qt${QT_VERSION_MAJOR} REQUIRED COMPONENTS ${OD_USEQT} GLOBAL )
		endif()
	    endforeach()
