...
#		  ${QT_QTGUI_LIBRARY_RELEASE} ${QT_QTXML_LIBRARY_RELEASE} )
	SET( QARGS ${QT_QTOPENGL_LIBRARY_RELEASE} ${QT_QTCORE_LIBRARY_RELEASE}
		  ...
		  ${QT_QTGUI_LIBRARY_RELEASE} ${QT_QTXML_LIBRARY_RELEASE} )
	FOREACH( QLIB ${QARGS} )
		get_filename_component( FILENAME ${QLIB} NAME_WE )
		IF( ${OD_PLFSUBDIR} STREQUAL "lux64" OR ${OD_PLFSUBDIR} STREQUAL "lux32" )
		    LIST( APPEND ARGS ${QTDIR}/lib/${FILENAME}.so )
		    FILE( GLOB ALLLIBS ${QTDIR}/lib/${FILENAME}.so*[1-9] )
		ELSEIF( APPLE )
		    FILE( GLOB ALLLIBS ${QTDIR}/lib/${FILENAME}*.dylib )
		ENDIF()
		FOREACH( LIB ${ALLLIBS} )
