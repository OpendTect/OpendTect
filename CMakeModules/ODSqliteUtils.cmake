...
macro( OD_FIND_SQLITE )
	...
	if ( TARGET SQLite3::SQLite3 )
	    od_setup_external_target( SQLite3::SQLite3 )
	elseif ( TARGET SQLite::SQLite3 )
	    od_setup_external_target( SQLite::SQLite3 )
	    add_library( SQLite3::SQLite3 ALIAS SQLite::SQLite3 )
	endif()
	if ( TARGET SQLite3::SQLite3 OR TARGET SQLite::SQLite3 )
...
macro( OD_SETUP_SQLITE )
	...
	if ( OD_LINKSQLITE )
	    list( APPEND OD_MODULE_EXTERNAL_LIBS SQLite3::SQLite3 )
	elseif ( OD_USESQLITE )
	    list( APPEND OD_MODULE_EXTERNAL_RUNTIME_LIBS SQLite3::SQLite3 )
	endif()
    else()
