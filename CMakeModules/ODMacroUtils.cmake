...
if ( OD_MODULE_HAS_LIBRARY )
    ...
    set ( TARGET_PROPERTIES ${OD_MODULE_NAME}
	    ...
	    ARCHIVE_OUTPUT_DIRECTORY_RELWITHDEBINFO "${PROJECT_OUTPUT_DIR}/${OD_LIB_RELPATH_RELEASE}"
	    ...
	    LIBRARY_OUTPUT_DIRECTORY_RELWITHDEBINFO "${PROJECT_OUTPUT_DIR}/${OD_LIB_RELPATH_RELEASE}"
	    ...
	    RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO "${PROJECT_OUTPUT_DIR}/${OD_LIB_RELPATH_RELEASE}"
	    PDB_OUTPUT_DIRECTORY_DEBUG "${PROJECT_OUTPUT_DIR}/${OD_LIB_RELPATH_DEBUG}"
	    PDB_OUTPUT_DIRECTORY_RELEASE "${PROJECT_OUTPUT_DIR}/${OD_LIB_RELPATH_RELEASE}"
	    PDB_OUTPUT_DIRECTORY_RELWITHDEBINFO "${PROJECT_OUTPUT_DIR}/${OD_EXEC_RELPATH_RELEASE}" )
...
if( OD_MODULE_TESTPROGS OR OD_MODULE_PROGS OR OD_MODULE_GUI_PROGS OR OD_ELEVATED_PERMISSIONS_PROGS OR OD_ELEVATED_PERMISSIONS_GUI_PROGS )
	...
	set( TARGET_PROPERTIES ${TARGET_NAME}
	    ...
	    ARCHIVE_OUTPUT_DIRECTORY_RELWITHDEBINFO "${PROJECT_OUTPUT_DIR}/${OD_EXEC_RELPATH_RELEASE}"
	    ...
	    RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO "${PROJECT_OUTPUT_DIR}/${OD_EXEC_RELPATH_RELEASE}"
	    PDB_OUTPUT_DIRECTORY_DEBUG "${PROJECT_OUTPUT_DIR}/${OD_EXEC_RELPATH_DEBUG}"
	    PDB_OUTPUT_DIRECTORY_RELEASE "${PROJECT_OUTPUT_DIR}/${OD_EXEC_RELPATH_RELEASE}"
	    PDB_OUTPUT_DIRECTORY_RELWITHDEBINFO "${PROJECT_OUTPUT_DIR}/${OD_EXEC_RELPATH_RELEASE}" )
...
if ( WIN32 AND (OD_${OD_MODULE_NAME}_EXTERNAL_LIBS OR
	...
	if ( ODEXECPATH AND NOT "${ODEXECPATH}" STREQUAL "" )
...
macro( OD_INSTALL_DATADIR_MOD DIRNM )
    if ( NOT IS_DIRECTORY "${OD_BINARY_BASEDIR}/${OD_DATA_INSTALL_RELPATH}/${DIRNM}" )
	file( MAKE_DIRECTORY "${OD_BINARY_BASEDIR}/${OD_DATA_INSTALL_RELPATH}/${DIRNM}" )
    endif()
    file( TOUCH "${OD_BINARY_BASEDIR}/${OD_DATA_INSTALL_RELPATH}/${DIRNM}/${OD_MODULE_NAME}.txt" )
    install( FILES "${OD_BINARY_BASEDIR}/${OD_DATA_INSTALL_RELPATH}/${DIRNM}/${OD_MODULE_NAME}.txt"
