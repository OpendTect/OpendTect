...
# 	Jan 2012	K. Tingdahl
#	RCS :		$Id: ODMacroUtils.cmake,v 1.29 2012-03-09 12:33:11 cvskris Exp $
...
IF ( OD_IS_PLUGIN )
    INSTALL(TARGETS
	    ${OD_MODULE_NAME}
	    RUNTIME DESTINATION ${OD_PLUGIN_INSTALL_PATH}
	    LIBRARY DESTINATION ${OD_PLUGIN_INSTALL_PATH}
	    ARCHIVE DESTINATION lib )
    INSTALL(TARGETS
	    ${OD_MODULE_NAME}
	    RUNTIME DESTINATION ${OD_LIBRARY_INSTALL_PATH} 
	    LIBRARY DESTINATION ${OD_LIBRARY_INSTALL_PATH}
	    ARCHIVE DESTINATION lib )
ENDIF()
