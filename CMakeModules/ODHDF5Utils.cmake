...
macro( OD_FIND_HDF5 )
    ...
    if ( NOT HDF5_FOUND )
	find_package( HDF5 QUIET COMPONENTS C CONFIG GLOBAL PATHS "${HDF5_ROOT}" HINTS "${CMAKE_PREFIX_PATH}" NO_DEFAULT_PATH )
	if ( NOT TARGET hdf5::hdf5-shared )
	    if ( CMAKE_PREFIX_PATH )
		set( _OD_HDF5_ROOT "${HDF5_ROOT}" )
		set( HDF5_ROOT "${CMAKE_PREFIX_PATH}" )
		find_package( HDF5 QUIET MODULE COMPONENTS C GLOBAL )
