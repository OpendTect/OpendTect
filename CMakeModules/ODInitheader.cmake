...
macro( OD_CREATE_INIT_HEADER )
    ...
    if ( OD_IS_PLUGIN )
	if ( IS_DIRECTORY "${CMAKE_SOURCE_DIR}/plugins/${OD_MODULE_NAME}" )
	    set ( INITHEADER_DIR "${PROJECT_BINARY_DIR}/${MISC_INSTALL_PREFIX}/plugins/${OD_MODULE_NAME}" )
	    set ( EXPORTHEADER_DIR "${CMAKE_SOURCE_DIR}/plugins/${OD_MODULE_NAME}" )
	else()
	    message( FATAL_ERROR "Cannot determine the output location for the generated ${OD_MODULE_NAME_LOWER}mod.h header file" )
	endif()
    else ()
	...
	elseif ( IS_DIRECTORY "${CMAKE_SOURCE_DIR}/spec/${OD_MODULE_NAME}" )
	    set ( INITHEADER_DIR "${PROJECT_BINARY_DIR}/${MISC_INSTALL_PREFIX}/spec/${OD_MODULE_NAME}" )
	    set ( EXPORTHEADER_DIR "${CMAKE_SOURCE_DIR}/spec/${OD_MODULE_NAME}" )
	elseif ( IS_DIRECTORY "${CMAKE_SOURCE_DIR}/${OD_MODULE_NAME}" )
	    set ( INITHEADER_DIR "${PROJECT_BINARY_DIR}/${MISC_INSTALL_PREFIX}/${OD_MODULE_NAME}" )
	    set ( EXPORTHEADER_DIR "${CMAKE_SOURCE_DIR}/${OD_MODULE_NAME}" )
	else()
	    message( FATAL_ERROR "Cannot determine the output location for the generated ${OD_MODULE_NAME_LOWER}mod.h header file" )
	endif()
    endif ()
