...
________________________________________________________________________
 ...
 Author:	Nageswara
 Date:		April 2010
RCS:		$Id: gmtfault.cc,v 1.1 2010-04-07 09:26:18 cvsnageswara Exp $
________________________________________________________________________
...
bool GMTFault::execute( std::ostream& strm, const char* fnm )
{
    ...
    Coord3 normal = (p1-p0).cross(p3-p0).normalize();
    ...
    if ( size == 0 )
    {
	strm << "Selected Z Slice and Fault are not intersected" << std::endl;
	return true;
    }
