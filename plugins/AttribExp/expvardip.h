...
________________________________________________________________________
 ...
 Date:          07-10-1999
 RCS:           $Id: expvardip.h,v 1.1 2002-01-04 14:05:40 kristofer Exp $
________________________________________________________________________
...
protected:
	...
	AttribCalc::Task*    clone() const 
			{ return new MinVarianceDipAttrib::Task(*this); }
    ...
    friend MinVarianceDipAttrib::Task;
    friend MinVarianceDipAttrib::Task::Input;
};
