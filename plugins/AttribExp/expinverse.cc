...
static const char* mUnusedVar rcsID = "$Id: expinverse.cc,v 1.11 2012-05-02 11:52:42 cvskris Exp $";
...
{ 
    ...
    spec->setDesc("Data on which the Inverse should be performed");
    inputspec += spec;
...
InverseAttrib::Task::Task( const InverseAttrib& calculator_ )
    : out0( 0 )
    , out1( 0 )
    , tracesegments( 0 )
    , spectrum0( 0 )
...
int InverseAttrib::Task::nextStep()
{
    ...
    InverseAttrib::Task::Input* inp = (InverseAttrib::Task::Input*)input;
