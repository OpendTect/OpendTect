...
________________________________________________________________________
 ...
 Author:        Jaap Glas
 Date:          January 2009
 RCS:           $Id: cmddriverbasics.h,v 1.22 2011/09/05 14:40:51 cvsjaap Exp $
 ________________________________________________________________________
...
mGlobal const char* windowTitle(const uiMainWin*, int aliasnr=0);
