...
-*/
static const char* rcsID = "$Id: command.cc,v 1.29 2011/09/05 14:40:51 cvsjaap Exp $";
...
void Command::finishActivate( bool busywait )
{ return drv_.finishActivate( busywait ); }
