...
________________________________________________________________________
 ...
 Author:        Jaap Glas
 Date:          February 2009
 RCS:           $Id: command.h,v 1.39 2012/03/26 13:57:34 cvsjaap Exp $
 ________________________________________________________________________
...
\
	...
	mSearchKey(winstr).getMatchingWindows( windowlist, &wildcardMan() ); \
    } \
    else \
...
#define mActivateInGUIThread( typ, constructorcall, busywait, waitclear ) \
{ \
...
#define mActivate( acttyp, constructorcall ) \
    mActivateInGUIThread( acttyp, constructorcall, true, true )

#define mActivateNoClearance( acttyp, constructorcall ) \
    mActivateInGUIThread( acttyp, constructorcall, true, false )

#define mActivateNoWait( acttyp, constructorcall ) \
    mActivateInGUIThread( acttyp, constructorcall, false, false )
