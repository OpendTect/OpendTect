...
protected:
    ...
    uiLineEdit*		srfld_;
    uiSEGYByteNr*	xcoordbytefld_			= nullptr;
    uiSEGYByteNr*	ycoordbytefld_			= nullptr;
    uiSEGYByteNr*	inlbytefld_			= nullptr;
    uiSEGYByteNr*	crlbytefld_			= nullptr;
    uiSEGYByteNr*	trcnrbytefld_			= nullptr;
    uiSEGYByteNr*	refnrbytefld_			= nullptr;
    uiSEGYByteNr*	offsetbytefld_			= nullptr;
    uiSEGYByteNr*	azimuthbytefld_			= nullptr;

    uiComboBox*		nrsampsrcfld_;
    uiComboBox*		zsampsrcfld_;
    uiComboBox*		trcnrsrcfld_			= nullptr;
    uiGroup*		trcnrgengrp_			= nullptr;
    uiLineEdit*		trcnrgenstartfld_		= nullptr;
    uiLineEdit*		trcnrgenstepfld_		= nullptr;
    uiComboBox*		psoffsrcfld_			= nullptr;
    uiGroup*		offsgengrp_			= nullptr;
    uiLineEdit*		offsgenstartfld_		= nullptr;
    uiLineEdit*		offsgenstepfld_			= nullptr;
