...
| BRANCH | DEPENDENCIES |
| -------------| ----------------- |
| main | [Qt 6.9.2](https://download.qt.io/archive/qt/6.9/6.9.2/), [OpenSceneGraph 3.6.5](https://github.com/openscenegraph/OpenSceneGraph/archive/OpenSceneGraph-3.6.5.tar.gz), [Proj 9.6.2 (optional)](https://download.osgeo.org/proj/proj-9.6.0.tar.gz), [Sqlite 3.49.2 (optional)](https://www.sqlite.org/download.html), [HDF5 1.14.6 (optional)](https://www.hdfgroup.org/downloads/hdf5) |
...
-  Optionally Qt source code is available for all the versions in use:
	- [Qt 6.9.2](https://dgbearthsciences.sharefile.com/public/share/web-s9ed64bd347d44aa6b46dfde1cfa5c98a) : main
