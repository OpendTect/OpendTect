...
| BRANCH | DEPENDENCIES |
| -------------| ----------------- |
| main, od8.0 | [Qt 6.8.1](https://download.qt.io/archive/qt/6.8/6.8.1/), [OpenSceneGraph 3.6.5](https://github.com/openscenegraph/OpenSceneGraph/archive/OpenSceneGraph-3.6.5.tar.gz), [Proj 9.5.1 (optional)](https://download.osgeo.org/proj/proj-9.5.1.tar.gz), [Sqlite 3.47.2 (optional)](https://www.sqlite.org/download.html), [HDF5 1.14.5 (optional)](https://www.hdfgroup.org/downloads/hdf5) |
