...
| BRANCH | DEPENDENCIES |
| -------------| ----------------- |
| main | [Qt 6.9.2](https://download.qt.io/archive/qt/6.9/6.9.2/), [OpenSceneGraph 3.6.5](https://github.com/openscenegraph/OpenSceneGraph/archive/OpenSceneGraph-3.6.5.tar.gz), [Proj 9.7.1 (optional)](https://download.osgeo.org/proj/proj-9.7.1.tar.gz), [Sqlite 3.51.1 (optional)](https://www.sqlite.org/download.html), [HDF5 2.0.0 (optional)](https://www.hdfgroup.org/downloads/hdf5) |
